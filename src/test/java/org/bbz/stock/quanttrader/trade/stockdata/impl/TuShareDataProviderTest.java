...
//    suite.
    ...
    public void testFunction(){
      ...
      System.out.println(i);
        ...
        final JsonObject apply1 = f2.compose( str -> str + str.getClass().getName() ).apply( "a.b.b." );
        System.out.println( "apply1=" + apply1 );

        Function<String, String> f3 = s -> s + s.getClass().getName() ;
        ...
        BiFunction<String, Integer, String> bf11 = bf1.andThen( d -> d.toString() );
        Integer a = bf1.andThen( d -> d.toString() ).andThen( s->(int)Double.parseDouble( s ) ).apply( "a", 123 );

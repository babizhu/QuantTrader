...
public interface IStockDataProvider{
     ...
     * stock：股票代码，即6位数字代码，或者指数代码（sh=上证指数 sz=深圳成指 hs300=沪深300指数 sz50=上证50 zxb=中小板 cyb=创业板）
     ...
     */
    void getSimpleKBar( String stock, KLineType kLineTypeType, int count, Handler<AsyncResult<List<SimpleKBar>>> resultHandler );
     ...
     */
    void getSimpleKBar( String stock, KLineType kLineType, int count,
                        LocalDate start,
                        LocalDate end,
     ...
     * @param resultHandler     回调
     */
    void getCurrentKbar( String stock, Handler<SimpleKBar> resultHandler  );

//    void getCurrentPrice(String stock,Handler<Float> resultHandler );
}
